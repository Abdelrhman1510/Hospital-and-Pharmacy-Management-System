...
class InvoicesRepository implements InvoicesRepositoryInterface
{
    ...
    {
        $invoices = Laboratorie::where('case',1)->where('employee_id',\Illuminate\Support\Facades\Auth::user()->id)->get();
    ...
    public function view_laboratories($id)
    {
        ...
        if($laboratorie->employee_id !=\Illuminate\Support\Facades\Auth::user()->id){
            //abort(404);
