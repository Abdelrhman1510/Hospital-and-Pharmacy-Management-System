...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/receipts.title')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/invoices.exchanges')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Payment.create')}}" class="btn btn-primary" role="button"
                                           aria-pressed="true">{{trans('Dashboard/invoices.add new exchange')}}</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{trans('Dashboard/invoices.statement')}}</th>
                                           ...
                                           @foreach($payments as $payment)
                                               <tr>
                                                   ...
                                                   <td>
                                                       ...
                                                       <a href="{{route('Payment.show',$payment->id)}}" class="btn btn-primary btn-sm" target="_blank" title="{{trans('Dashboard/invoices.print')}}"><i class="fas fa-print"></i></a>
                                                    </td>
                                               </tr>
