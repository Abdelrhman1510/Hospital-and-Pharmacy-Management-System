...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active ">
        ...
        <a class="desktop-logo logo-dark active" href=""><img src="{{ asset('Website/images/hospital.png') }}" class="main-logo dark-theme" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href=""><img src="{{ asset('Website/images/hospital.png') }}" class="logo-icon" alt="logo"></a>
