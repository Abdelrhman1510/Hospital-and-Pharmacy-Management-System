...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="#"><img src="{{ asset('Website/images/hospital.png') }}" class="main-logo" alt="logo"></a>
    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                <img alt="user-img" class="avatar avatar-xl brround" src="{{ asset('Dashboard/img/doctors/' . Auth::user()->image->filename) }}">
<span class="avatar-status profile-status bg-green"></span>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">Doctor's Records</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices.index') }}">Records List</a></li>
                    <li><a class="slide-item" href="{{ route('completedInvoices') }}">Completed Records</a></li>
    ...
    <ul class="slide-menu">
        <li><a class="slide-item" href="{{route('chat.patients')}}">Recent Conversations</a></li>
    </ul>
</li>
