<!-- Modal -->
<div class="modal fade" id="delete{{ $pharmacy_employee->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('pharmacy_employee.destroy', $pharmacy_employee->id) }}" method="post">
                ...
                <div class="modal-body">
                    <h5>{{trans('Dashboard/sections_trans.Warning')}} {{$pharmacy_employee->name}}</h5>
                </div>
