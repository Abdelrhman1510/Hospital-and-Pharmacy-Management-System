...
@section('title')
{{trans('Dashboard/receipts.receivables')}}
@stop
@section('css')
    <style>
        @media print {
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/invoices.prRe')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">{{trans('Dashboard/invoices.re')}}</h1>
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>{{trans('Dashboard/invoices.invoice date')}}</span> <span>{{$receipt->date}}</span>
                                </p>
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="tx-center">{{trans('Dashboard/invoices.price')}}</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
