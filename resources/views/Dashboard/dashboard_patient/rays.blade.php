    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Radiology</span>
            </div>
        </div>
    </div>
    <!-- Breadcrumb -->
                        ...
                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th>Required</th>
                                    <th>Doctor Name</th>
                                    <th>Radiology Doctor Name</th>
                                    <th>Radiology Doctor Notes</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($ray->employee_id !== null)
                                                <a class="btn btn-primary btn-sm" href="{{ route('rays.view', $ray->id) }}" role="button">View Radiology</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
