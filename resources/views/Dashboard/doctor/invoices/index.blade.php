...
@section('title')
{{trans('Dashboard/doctors_trans.ex')}}@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/doctors_trans.ex')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/invoices.title')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@include('Dashboard.messages_alert')
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                      @if($invoice->invoice_status == 1)
                                                           <span class="badge badge-danger">{{trans('Dashboard/doctors_trans.up')}}</span>
                                                      @elseif($invoice->invoice_status == 2)
                                                           <span class="badge badge-warning">{{trans('Dashboard/doctors_trans.re')}}</span>
                                                       @else
                                                          <span class="badge badge-success">{{trans('Dashboard/doctors_trans.comp')}}</span>
                                                       @endif
                                                   </td>
    ...
    <div class="dropdown-menu tx-13">
        ...
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#xray_conversion{{$invoice->id}}"><i class="text-primary fas fa-x-ray"></i>&nbsp;&nbsp;ٌRefer to X-Ray</a>
