...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/ambulacne.Ambulances')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/ambulacne.add')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-body">
                <form action="{{route('ambulance.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label>{{trans('Dashboard/ambulacne.car_model')}}</label>
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" name="car_type">
                                <option value="1">{{trans('Dashboard/ambulacne.owned')}}</option>
                                <option value="2">{{trans('Dashboard/ambulacne.rented')}}</option>
                            </select>
                        </div>
