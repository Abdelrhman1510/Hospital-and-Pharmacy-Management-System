            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        <img src="{{ asset('Website/images/h1.jpg') }}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
                    </div>
                </div>
            </div>
            <!-- The content half -->
                        ...
                        <div class="row">
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 d-flex"> <a href=""><img src="{{ asset('Website/images/hospital.png') }}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Hos<span>pit</span>al</h1></div>
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="sectionChooser">
                                                    ...
                                                    <option value="ray_employee">Log in as ray employee</option>
                                                    <option value="laboratorie_employee">Log in as Lab Employee</option>
                                                    <option value="pharmacy_employee">Log in as Pharmacy Employee</option>
                                            ...
                                            <div class="panel" id="pharmacy_employee">
                                                <h2>Login as pharmacy Employee</h2>
...
{{-- Laboratory Employee Login Form --}}
<div class="panel" id="laboratorie_employee">
    <h2>Laboratory Employee Login</h2>
